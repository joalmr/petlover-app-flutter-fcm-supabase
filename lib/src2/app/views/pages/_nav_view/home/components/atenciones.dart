...
import 'package:proypet/src2/controllers/home_controller/atencion_home_controller.dart';
                            ...
                            confirmDismiss: (fn) => showDialog(
                              ...
                              builder: (BuildContext context) => FadeIn(
                                child: AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    buttonModal('Cancelar', _.volver, Theme.of(context).textTheme.subtitle2.color),
