          ...
          child: ListView(
            ...
            children: <Widget>[
              FormularioText(
                ...
                icon: Icons.lock,
                iconSuf: InkWell(
                  child: Icon(!clave1 ? Icons.visibility_off : Icons.visibility),
                  onTap: () {
                    setState(() {
                      clave1 = !clave1;
                    });
              ...
              FormularioText(
                ...
                icon: Icons.lock,
                iconSuf: InkWell(
                  child: Icon(!clave2 ? Icons.visibility_off : Icons.visibility),
                  onTap: () {
                    setState(() {
                      clave2 = !clave2;
                    });
              ...
              Center(child: buttonPri('Cambiar contraseña', clickPassword ? _changePassword : null) //()=>agregarDialog()
                  )
            ],
          ),
        ),
