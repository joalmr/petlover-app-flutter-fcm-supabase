...
Widget _onDetail(context){
  return Column(
                children: <Widget>[
                  Container(
                    height: 325.0,
                    width: double.infinity,
                    child: _swiperVets(vetLocales[0].imagen)
                  ),
                  SizedBox(height: .5),
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        title: Text(vetLocales[0].nombre,//nombreVet(0),
                          maxLines: 2,
                          style: TextStyle(
                            fontSize: 20.0,
                        ...
                        subtitle: Row(
                          children: <Widget>[
                            ...
                            Text(vetLocales[0].distancia+' [ Paseo los franciscanos 529 ] ',
                            style: TextStyle(
                              fontSize: 12.0,
                              color: Colors.grey
                            ),
                        ...
                        trailing: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: CachedNetworkImageProvider(vetLocales[0].logo),
                              fit: BoxFit.cover
                            )
                          ),
                        ),
                              ...
                              children: <Widget>[
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(vetLocales[0].votantes,
                                        style: TextStyle(
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            SizedBox(width: 5.0),
                                            Text(vetLocales[0].estrellas,style: TextStyle(color: Colors.white))
                                          ],
                                        ),
                                      )
                                    )
