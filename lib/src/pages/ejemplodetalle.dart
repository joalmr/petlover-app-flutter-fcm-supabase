                ...
                child: Center(
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text('Reservar',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15.0),),
                    ],
                  ),
                )
              ),
            ...
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 15.0),
                    child: Text('Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione architecto autem quasi nisi iusto eius ex dolorum velit! Atque, veniam! Atque incidunt laudantium eveniet sint quod harum facere numquam molestias?')
                  ),
                                  ],
              ),
            ),
