  ...
  _banio(data, context){
    return Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 10,),
        Text("Recomendación", style: TextStyle( fontWeight: FontWeight.bold, fontSize: sizeLite ),),
        Text((data["recommendations"]!=null) ? data["recommendations"] : "-"),
        SizedBox(height: 10,),
        Text("Atendido por", style: TextStyle( fontWeight: FontWeight.bold, fontSize: sizeLite ),),
