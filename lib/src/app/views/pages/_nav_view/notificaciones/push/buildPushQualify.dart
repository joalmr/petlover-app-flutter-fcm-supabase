...
//                       widget.noti['establishment_logo']),
//                   height: 65,
//                   fit: BoxFit.cover,
//                 ),
//               ),
...
//   _onRate() async {
//     print(widget.noti['attention_id']);

//     AtencionModel atencion = new AtencionModel();
//     atencion.attentionId = widget.noti['attention_id'];
