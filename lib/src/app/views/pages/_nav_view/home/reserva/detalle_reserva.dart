              ...
              child: Stack(
                children: <Widget>[
                  Container(
                    child: Image(
                      image:
                          CachedNetworkImageProvider(_.argumentos.petPicture),
                      height: 340,
                  ...
                  Card(
                    margin: EdgeInsets.only(
                        top: 290.0, bottom: 7.5, left: 5.0, right: 5.0),
                    child: SingleChildScrollView(
                              ...
                              children: <Widget>[
                                      ...
                                      children: <Widget>[
                                        ...
                                        (!_.vencido)
                                            ? Text(_.argumentos.status,
                                                style: (_.argumentos.statusId ==
                                                            3 ||
                                                        _.argumentos.statusId ==
                                                            6)
                                ...
                                Text("Fecha y hora",
                                    style: Get.textTheme.subtitle2
                                        .apply(fontWeightDelta: 2)),
                                Text(
                                    '${_.argumentos.date}  ${_.argumentos.time}'),
                                SizedBox(height: 10.0),
                                Text("Servicios",
                                    style: Get.textTheme.subtitle2
                                        .apply(fontWeightDelta: 2)),
                  ...
                  Positioned(
                    ...
                    ), //appbar(null, 'Detalle de reserva', null),
                  )
                ],
              ),
            ),
